...
class Match(models.Model):
    ...
    three_way_odds = models.CharField(max_length=20, blank=True)
    double_chance_odds = models.CharField(max_length=20, blank=True)
    over_under_25_odds = models.CharField(max_length=20, blank=True)
    both_to_score_odds = models.CharField(max_length=20, blank=True)
